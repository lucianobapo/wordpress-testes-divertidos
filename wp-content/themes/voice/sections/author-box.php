<section class="main-box mbt-border-top author-box">
	...
	<div class="vce-content-outside">
		...
		<div class="vce-author-links">
			<?php if (get_the_author_meta('url')) {?> <a href="<?php the_author_meta('url'); ?>" target="_blank" class="fa fa-link vce-author-website"><span><?php echo __vce('author_website'); ?></span></a><?php } ?>
