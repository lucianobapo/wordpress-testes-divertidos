<div class="vce-grid-item">
    ...
    <div class="vce-featured-info">
        ...
        <h2 class="vce-featured-title">
            <a class="vce-featured-link-article" href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>"><?php echo esc_html( vce_get_title( 'lay-fa-grid' ) ); ?></a>
        </h2>
